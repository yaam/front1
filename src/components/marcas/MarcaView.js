                                                                ...
                                                                <ul>
                                                                  {
                                                                    marcas.map((marca)=>{
                                                                      return (
                                                                        <table class="table table-striped" key={marca._id}>
                                                                        <thead>
                                                                        <tr>
                                                                        <ul className="list-group list-group-horizontal" key={marca._id} >
                                                                        <th scope="col">Nombre</th>
                                                                        <li className="list-group-item"  key={marca.nombre}>{marca.nombre}
                                                                        </li>
                                                                        <th scope="col">estado</th>
                                                                        <li className="list-group-item"  key={marca.estado}>{marca.estado}
                                                                        </li>
                                                                        <th scope="col">Fecha Creacion</th>
                                                                        <li className="list-group-item"  key={marca.fechaCreacion}>{dayjs(marca.fechaCreacion).format('YYYY-MM-DD')}
                                                                        </li>
                                                                        <th scope="col">Fecha Actualizaciòn</th>
                                                                        <li className="list-group-item"  key={marca.fechaActualizacion}>{dayjs(marca.fechaActualizacion).format('YYYY-MM-DD')}
                                                                        </li>
